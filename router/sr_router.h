...
void sr_handle_arp_req(struct sr_instance* , uint8_t * , unsigned int , char* );
void sr_send_arp_req(struct sr_instance *, uint8_t *, unsigned int, char *);
...
void sr_send_icmp_packet(struct sr_instance *, uint8_t *, uint8_t, uint8_t);
